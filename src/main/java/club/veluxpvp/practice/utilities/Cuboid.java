...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    @Getter @Setter protected Location location1, location2;
    ...
    public Cuboid(World world, int x1, int y1, int z1, int x2, int y2, int z2) {
        ...
        this.location1 = new Location(Bukkit.getWorld(this.worldName), this.x1, this.y1, this.z1);
        this.location2 = new Location(Bukkit.getWorld(this.worldName), this.x2, this.y2, this.z2);
    }
