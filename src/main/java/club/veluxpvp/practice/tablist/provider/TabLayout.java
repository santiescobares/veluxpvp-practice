...
public class TabLayout {
	...
	private final EightTab instance;
	
	private final Player player;
	private final EntityPlayer entityPlayer;
	
	public TabLayout(EightTab instance, Player player) {
	...
	public void update(int column, int row, String text, int ping, Skin skin) {
		...
		Bukkit.getScheduler().runTaskAsynchronously(Practice.getInstance(), () -> fetchPing(index, gameProfile, ping));
		//TODO: updating tab skin
		Bukkit.getScheduler().runTaskAsynchronously(Practice.getInstance(), () -> fetchSkin(index, gameProfile, skin));
	}
